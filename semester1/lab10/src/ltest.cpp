/*
  ...
  UWAGA: Prosze przemyslec "poprawnosc const" od poczatku.
   	...
   	com:2 () doc:1 () exec:0 (segfault) code:4 (ok, prosze pamietac ze stale w kodzie sa malo czytelne, tu: if (location == 1 ) mozna zastapic if ( location == Begin ) i kod zaczyna byc bardziej zrozumialy.) suma:7
